    ...
    <div class="top-button is-right">
      ...
      <el-dropdown @command="handleCommand">
        ...
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item command="CN">中文界面</el-dropdown-item>
          <el-dropdown-item command="EN">英文界面</el-dropdown-item>
          <el-dropdown-item>
...
export default {
  ...
  methods: {
    handleCommand(text) {
      if (text === 'CN') {
        this.$i18n.locale = 'cn';
        setStore({ name: 'lang1', content: 'cn', type: 'session' })
      }else if (text === 'EN') {
        this.$i18n.locale = 'en';
        setStore({ name: 'lang1', content: 'en', type: 'session' })
      }else {
        return
      }
    },
